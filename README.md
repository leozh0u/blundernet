...
3. **Evaluates** top-1 / top-3 move-prediction accuracy on a held-out slice it never
   trained on, and appends to [`metrics/history.csv`](metrics/history.csv)
...
- [ ] Lichess tactics-puzzle evaluation suite (accuracy vs puzzle rating buckets)
